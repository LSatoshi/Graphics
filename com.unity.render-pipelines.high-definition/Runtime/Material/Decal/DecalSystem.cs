        ...
        private partial class DecalSet : IDisposable
        {
            ...
            public DecalHandle AddDecal(int materialID, DecalProjector decalProjector)
            {
                ...
                if (m_DecalsCount == m_Handles.Length)
                {
                    ...
                    ArrayUtils.ResizeArray(ref m_Handles, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedDrawDistances, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedAngleFade, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedUVScaleBias, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedAffectsTransparency, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedLayerMask, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedSceneLayerMask, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedDecalLayerMask, newCapacity);
                    ArrayUtils.ResizeArray(ref m_CachedFadeFactor, newCapacity);
                }
